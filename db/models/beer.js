...
module.exports = db => db.define('beer', {
    ...
    imageURL: {type: sequelize.STRING, defaultValue: 'https://www.crafthounds.com/wp-content/uploads/2016/11/No-Image-Available.png', validate: {notEmpty:true}},
