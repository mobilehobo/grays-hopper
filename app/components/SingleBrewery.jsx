...
const SingleBrewery = props => {
	...
	const matchedBrewery = breweriesList.filter(brewery => brewery.id === selectedBreweryId)[0];

	const matchedBeers = beerList.filter(beer => beer.parentCompany.id === selectedBreweryId);
